            ...
            <div className="w-full h-[500px] items-center flex ">
                ...
                <div className="h-[450px] w-[600px] flex-col mr-10 my-10 items-center">
                    <div className="h-[270px] w-full  mb-5 rounded-2xl shadow-lg">
                        ...
                        <img src="https://png.pngtree.com/thumb_back/fh260/background/20230611/pngtree-various-makeup-products-lie-on-a-table-on-dark-image_2908578.jpg" alt="beauty" className="h-[270px] w-full rounded-2xl "/>
